...
internal struct KeepAliveFrameBodyDecoder: FrameBodyDecoding {
    internal func decode(from buffer: inout ByteBuffer, header: FrameHeader) throws -> KeepAliveFrameBody {
