...
internal struct RequestStreamFrameEncoder: FrameEncoding {
    ...
    internal func encode(frame: RequestStreamFrame, using allocator: ByteBufferAllocator) throws -> ByteBuffer {
