...
internal struct RequestResponseFrameBodyEncoder: FrameBodyEncoding {
    ...
    internal func encode(frame: RequestResponseFrameBody, into buffer: inout ByteBuffer) throws {
