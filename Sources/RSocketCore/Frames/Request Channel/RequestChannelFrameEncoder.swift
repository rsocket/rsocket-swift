...
internal struct RequestChannelFrameEncoder: FrameEncoding {
    ...
    internal func encode(frame: RequestChannelFrame, using allocator: ByteBufferAllocator) throws -> ByteBuffer {
