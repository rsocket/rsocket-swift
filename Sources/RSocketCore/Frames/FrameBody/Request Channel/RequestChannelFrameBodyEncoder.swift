...
internal struct RequestChannelFrameBodyEncoder: FrameBodyEncoding {
    ...
    internal func encode(frame: RequestChannelFrameBody, into buffer: inout ByteBuffer) throws {
