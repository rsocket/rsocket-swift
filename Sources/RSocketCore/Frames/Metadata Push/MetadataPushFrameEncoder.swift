...
internal struct MetadataPushFrameEncoder: FrameEncoding {
    ...
    internal func encode(frame: MetadataPushFrame, using allocator: ByteBufferAllocator) throws -> ByteBuffer {
