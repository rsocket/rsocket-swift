...
internal struct ExtensionFrameBodyDecoder: FrameBodyDecoding {
    ...
    internal func decode(from buffer: inout ByteBuffer, header: FrameHeader) throws -> ExtensionFrameBody {
        ...
        return ExtensionFrameBody(
            canBeIgnored: header.flags.contains(.ignore),
